...
<div class="main-content" style="min-height: 668px;" ng-app="monthlySalesApp" ng-controller="MonthlySalesCtrl as form">
...
<script type="text/javascript">
    (function () {
        var monthlySalesApp = angular.module('monthlySalesApp', ['angular.filter']);
        monthlySalesApp.controller('MonthlySalesCtrl', function ($scope, $http, $sce, $compile) {
