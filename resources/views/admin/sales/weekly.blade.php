...
<div class="main-content" style="min-height: 668px;" ng-app="weekSalesApp" ng-controller="WeekSalesCtrl as form">
...
<script type="text/javascript">
    (function () {
        var weekSalesApp = angular.module('weekSalesApp', ['angular.filter']);
        weekSalesApp.controller('WeekSalesCtrl', function ($scope, $http, $sce, $compile) {
