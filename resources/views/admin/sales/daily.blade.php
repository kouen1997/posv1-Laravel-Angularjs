...
<div class="main-content" style="min-height: 668px;" ng-app="dailySalesApp" ng-controller="DailySalesCtrl as form">
...
<script type="text/javascript">
    (function () {
        var dailySalesApp = angular.module('dailySalesApp', ['angular.filter']);
        dailySalesApp.controller('DailySalesCtrl', function ($scope, $http, $sce, $compile) {
